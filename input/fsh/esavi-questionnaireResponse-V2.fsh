...
* item[=].text = "Datos Demográficos de Vacunado/a que ha manifestado ESAVI"
* item[=].item.linkId = "datosVacunado"
* item[=].item.text = "Datos del/la Vacunado/a que generó ESAVI"
...
* item[=].item[=].item[0].linkId = "esaviEventos"
