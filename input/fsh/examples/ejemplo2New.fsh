...
* item[=].item[=].item[=].answer.valueString = "Arritmia Cardiaca"
...
* item[=].item[=].item[=].answer.valueCoding.code = #10000126 "ECG Anormal"
...
* item[=].item[=].item[0].linkId = "nombreESAVI"
* item[=].item[=].item[=].answer.valueString = "Creatinina Alta"
* item[=].item[=].item[+].linkId = "IdentificadorESAVI"
* item[=].item[=].item[=].answer.valueInteger = 2
* item[=].item[=].item[+].linkId = "codigoESAVIMedDRA"
* item[=].item[=].item[=].answer.valueCoding.system = "https://paho.org/fhir/esavi/CodeSystem/MedDRACS"
* item[=].item[=].item[=].answer.valueCoding.code = #10011333 "Creatinina Elevada"
* item[=].item[=].item[+].linkId = "fechaESAVI"
* item[=].item[=].item[=].answer.valueDate = "2021-07-21"
* item[=].item[=].item[+].linkId = "descripcionESAVI"
...
* item[=].item[+].linkId = "datosESAVI"
* item[=].item[=].item[0].linkId = "nombreESAVI"
* item[=].item[=].item[=].answer.valueString = "Abseso grueso con pus"
* item[=].item[=].item[+].linkId = "IdentificadorESAVI"
* item[=].item[=].item[=].answer.valueInteger = 3
* item[=].item[=].item[+].linkId = "codigoESAVIMedDRA"
* item[=].item[=].item[=].answer.valueCoding.system = "https://paho.org/fhir/esavi/CodeSystem/MedDRACS"
* item[=].item[=].item[=].answer.valueCoding.code = #10000269 "Abseso"
* item[=].item[=].item[+].linkId = "fechaESAVI"
* item[=].item[=].item[=].answer.valueDate = "2021-07-21"
* item[=].item[=].item[+].linkId = "descripcionESAVI"
...
* item[=].item[+].linkId = "datosESAVI"
* item[=].item[=].item[0].linkId = "nombreESAVI"
* item[=].item[=].item[=].answer.valueString = "Ruidos Intestinales Fuertes"
* item[=].item[=].item[+].linkId = "IdentificadorESAVI"
* item[=].item[=].item[=].answer.valueInteger = 4
* item[=].item[=].item[+].linkId = "codigoESAVIMedDRA"
* item[=].item[=].item[=].answer.valueCoding.system = "https://paho.org/fhir/esavi/CodeSystem/MedDRACS"
* item[=].item[=].item[=].answer.valueCoding.code = #10000119 "Ruidos intestinales anormales"
* item[=].item[=].item[+].linkId = "fechaESAVI"
